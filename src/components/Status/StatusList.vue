...
<template>
    <div class="statusList">
        <div class="notFound" v-show="props.data.length == 0">
            <el-empty description="无结果" />
        </div>
        <div class="list" v-show="props.data.length != 0">
            <div class="header">
            ...
            <div class="item" v-for="(item, index) in props.data" :key="index">
                <div class="SID" style="width: 140px">
                    {{ item.SID }}
                </div>
                <div class="submitTime" style="width: 180px">
                    {{ proxy.Utils.TimeTools.timestampToTime(item.SubmitTime) }}
                </div>
                <div class="PID cursor_pointer" style="width: 120px" @click="goToProblem(item.PID)">
                    {{ item.PID }}
                </div>
                ...
                <div class="useMemory" :style="'width: 120px;' + (item.Result == 'MLE' ? 'color: #ff381e;' : '')">
                ...
                <div style="width: 120px; display: flex; justify-content: center;">
                    <div class="res cursor_pointer" :style="'color: #ffffff; background-color:' +
